...
public abstract class VisualTestCase extends CommandTestCase {
    ...
    private void prepareEditor(boolean inverted, String beforeSelection, String selected,
    ...
    private void assertCommandResult(String initialLine, boolean inverted, String beforeSelection,
            String selected, String afterSelection) {
    ...
    protected void checkCommand(Command command, boolean inverted1, String beforeSelection1,
            String selected1, String afterSelection1, boolean inverted2, String beforeSelection2, String selected2,
            String afterSelection2) {
    ...
    protected void checkLeavingCommand(Command command, boolean inverted,
            String beforeSelection, String selected, String afterSelection, String beforeCursor, char atCursor,
            String afterCursor) {
