...
public class SneakState {
     ...
     * be cleared every time this keyword is changed, either through EMInputMode or through a
     ...
     * It is the {@link StateManager}'s responsibility to sync it with the the global event
     * counter when
     * {@link StateManager#markSneakActive(net.sourceforge.vrapper.vim.EditorAdaptor, boolean, List)}
     * is called.
     */
